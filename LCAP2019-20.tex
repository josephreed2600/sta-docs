...
\begin{figure}
	...
	\pie[explode=0.2, radius=2, rotate=150, text=pin, before number=\phantom, after number=]{
		 ...
		 14.5/\pieslicecaption{All local funds}{92631}{14.5},
		  0.3/\pieslicecaption{All other state funds}{2000}{0.3},
		%81.7/\pieslicecaption{Total LCFF funds}{520717}{81.7},
		 73.2/\pieslicecaption{All Other LCFF funds}{466615}{73.2}
	}
	\end{tikzpicture}
...
\begin{planactions}[Complete a copy of the following table for each of the LEA's Actions/Services. Duplicate the table, including Budgeted Expenditures, as needed.]
	...
	\planaction@scope
	{English Learners, Foster Youth, and/or Low Income}{LEA-wide}{All Schools}
	\planaction@action
	{New}{Modified}{Modified}
