...
\usepackage[pdftex,
	pdflang={en-US},
	pdfauthor={Jamie Brock},
	pdftitle={Local Control Accountability Plan and Annual Update (LCAP) Template},
	pdfproducer={LaTeX},
	pdfcreator={pdflatex}
	]{hyperref}
...
\begin{figure}[hbtp]
\alt{A pie chart breaking down Sherman Thomas STEM Academy's revenue by fund source. About three quarters of the revenue comes from Other LCFF funds, one seventh from local funds, one twelfth from LCFF supplemental and concentration grants, three percent from federal funds, and less than one percent from other state funds.}
\centering
...
\begin{figure}[h!btp]
\alt{A bar graph illustrating Sherman Thomas STEM Academy's planned expenditures for 2019--20. The total planned expenditures are about six hundred forty thousand dollars, and the planned expenditures tied to actions/services in the LCAP are about two thirds of that: about four hundred eleven thousand dollars.}
\centering
...
\begin{figure}[h!btp]
\alt{A bar graph comparing the budgeted versus the estimated actual expenditures for actions to increase or improve services for high needs students in 2018--19. The budgeted expenditures were about fifty-four thousand dollars; the estimated actual expenditures were about forty-five thousand dollars.}
\centering
...
\actionupdate
	{Intervention Program (\SI{9.8}{\percent}) of 6\supth grade teacher's salary)}
	{Intervention Program (\SI{9.8}{\percent}) of 6\supth grade teacher's salary)}
	{7292}
	{8686}
